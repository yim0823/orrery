...
> 🔒 **이 리포는 아래 라이선스 문제가 정리될 때까지 비공개입니다.** 접근 권한 없이 이 문서를
> 보고 계시다면 클론 명령은 동작하지 않고, 지금으로서는 방법이 없습니다 — 링크가 깨진 게
> 아니라 프로젝트의 상태가 그렇습니다. CI 배지를 달지 않은 것도 같은 이유입니다. 저자만
...
**라이선스.** 첫 두 커밋 — `24f3d50`, `679d332`, 둘 다 2026-09-12 — 이 회사 장비의 회사
계정으로 작성됐습니다. 그 뒤로는 전부 개인 장비입니다. 사내 정보는 하나도 들어 있지 않고
실패-차단 커밋 훅이 그걸 막지만, **저작권은 기밀성의 문제가 아닙니다.** 업무상 저작물 규정은
생각보다 넓고, 주제와 무관하게 회사 장비에서 쓴 코드에 붙을 수 있습니다. 저자는 이것이 자기가
라이선스할 수 있는 저작물이라고 보고 [`NOTICE`](NOTICE)에 이름을 적었습니다 — 라이선서 이름이
없는 라이선스는 아무것도 허락하지 않기 때문입니다. **회사가 문서로 확인해 준 것은 아닙니다.**

저자가 아니라 **당신에게** 무슨 뜻인지: 소유권이 주장되면 해당 부분에 대한 Apache-2.0 허락이
다퉈질 수 있고, 그 다툼은 이 위에 쌓아 올린 것까지 닿습니다. 2차적 저작물은 라이선스 사슬의
하자를 그대로 물려받기 때문입니다. 면책을 제공할 수 있는 것도 없습니다. 법무 검토가 깨끗한
출처 사슬을 요구한다면 **이건 아직 그게 아닙니다.** 전문은 [`NOTICE`](NOTICE)에 있고,
상황이 바뀌면 가장 먼저 바뀔 파일이 그것입니다.
